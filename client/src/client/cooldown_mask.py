...
from common.behaviours.ui.ui_label import HorizontalAlign, UILabel, VerticalAlign
...
class CooldownMask(Behaviour):
    ...
    def on_init(self) -> Any:
        ...
        label_node.transform.local_position = Vector2(0, 0)
        self.label = label_node.add_behaviour(UILabel)
        self.label.horizontal_align = HorizontalAlign.CENTER
        self.label.vertical_align = VerticalAlign.MIDDLE
